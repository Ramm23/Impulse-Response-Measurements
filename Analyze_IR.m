...
xlim([0 t(end)]);
legend("Channel " + string(1:size(EDC_log,2))); % Change to 2 for columns
...
% Now with plotSTFT as well
[~] = plotSTFT(t,f,EDR1,fs,false);
[~] = plotSTFT(t,f,EDR2,fs,false);
